    ...
    <div>
      ...
      <div className="wrapper">
        <div className="sidebar">
          <ul>
            <SidebarItem icon={<AiFillControl size={20} />} to="/Paneljuan" text="Panel de control" />
            <SidebarItem icon={<MdRestaurant size={20} />} to="/Panelcocina" text="Cocina" />
